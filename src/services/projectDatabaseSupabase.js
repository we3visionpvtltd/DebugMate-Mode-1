    ...
    async saveProject(projectData) {
        try {
            ...
            if (!projectData.id) {
                ...
                projectData.id = customUUID;
                projectData.uuid = customUUID; // Keep both id and uuid in sync
            }
            ...
            const projectToSave = {
                ...
                project_field: this.mapTechStackToProjectField(projectData.techStack), // Add project field
            };

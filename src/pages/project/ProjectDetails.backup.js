  ...
  const getStatusColor = (status) => {
    ...
    switch (statusLower) {
      ...
      default:
        ...
        if (loading) {
          return (
            <StyledContainer className="d-flex justify-content-center align-items-center" style={{ minHeight: '60vh' }}>
        ...
        if (error || !project) {
          return (
            <StyledContainer className="d-flex justify-content-center align-items-center" style={{ minHeight: '60vh' }}>
              <div className="text-center">
                <h3 className="mb-3">Project Not Found</h3>
                <p className="text-muted mb-4">{error || 'The requested project could not be loaded.'}</p>
